...
data64 = np.loadtxt('replace_scantest_64.txt')
...
data32 = np.loadtxt('replace_scantest_32.txt')
...
data16 = np.loadtxt('replace_scantest_16.txt')
...
data8 = np.loadtxt('replace_scantest_8.txt')
...
data4 = np.loadtxt('replace_scantest_4.txt')
...
data2 = np.loadtxt('replace_scantest_2.txt')
...
data = np.loadtxt('replace_scantest_1.txt')
...
data11 = np.loadtxt('replace_rw1.txt')
...
data12 = np.loadtxt('replace_rw1_2.txt')
