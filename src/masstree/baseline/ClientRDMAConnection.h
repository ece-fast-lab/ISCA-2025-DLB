...
class ClientRDMAConnection {
public:
	ClientRDMAConnection(int id, int isLast, char *ib_devname_in, int gidx_in, int remote_qp0_in, char* servername);
...
//private:
	...
	static const unsigned int bufs_num = 80;
