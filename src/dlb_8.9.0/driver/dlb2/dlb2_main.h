...
extern const struct attribute_group *dlb2_sdev_attrs[];
extern struct dlb2_device_ops dlb2_pf_ops;
extern struct dlb2_device_ops dlb2_vf_ops;
extern struct dlb2_device_ops dlb2_sdev_ops;
...
struct dlb2 {
	...
	struct device *dev;
	struct device *dev1;
	struct device *sdev[DLB2_MAX_NUM_VDEVS];
	struct dlb2 *sdev_dlb2[DLB2_MAX_NUM_VDEVS];
	struct dlb2 *parent_dlb2;
